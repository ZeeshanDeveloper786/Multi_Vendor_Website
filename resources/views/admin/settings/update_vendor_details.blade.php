                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/personal') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vendor_name" class="form-control" id="vendor_name"
                                            placeholder="Enter Name" value="{{ $vendorDetails->name }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vendor_address" class="form-control" id="vendor_address"
                                            placeholder="Enter Address" value="{{ $vendorDetails->address }}" required>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vendor_city" class="form-control" id="vendor_city"
                                            placeholder="Enter city" value="{{ $vendorDetails->city }}" required>
                                        <span class="text-danger">
                                            @error('vendor_city')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vendor_state" class="form-control" id="vendor_state"
                                            placeholder="Enter State" value="{{ $vendorDetails->state }}" required>
                                        <span class="text-danger">
                                            @error('vendor_state')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vendor_pincode" class="form-control" id="vendor_pincode"
                                            placeholder="Enter Pincode" value="{{ $vendorDetails->pincode }}" required>
                                        <span class="text-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="vendor_image" class="form-control file-upload-info"
                                            id="vendor_image" placeholder="Enter Current Password">
                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shop_state" class="form-control" id="shop_state"
                                            placeholder="Enter shope state" value="{{ $vendorDetails->shop_state }}"
                                            required>
                                        <span class="text-danger">
                                            @error('shop_state')
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shop_mobile" class="form-control" id="shop_mobile"
                                            ...
                                            value="{{ $vendorDetails->shop_mobile }}" required>
                                        <span class="text-danger">
                                            @error('shop_mobile')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" value="" name="address_proof"
                                            id="address_proof">
                                            <option value="CNIC"
                                                {{ $vendorDetails->address_proof == 'CNIC' ? 'selected' : '' }}>CNIC
                                            </option>
                                            <option value="Passport"
                                                {{ $vendorDetails->address_proof == 'Passport' ? 'selected' : '' }}>
                                                Passport</option>
                                            <option value="Driving Liecence"
                                                {{ $vendorDetails->address_proof == 'Driving Liecence' ? 'selected' : '' }}>
                                                Driving Liecence</option>
                                        </select>
                                        <span class="text-danger">
                                            @error('address_proof')
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="address_proof_image"
                                            class="form-control file-upload-info" id="address_proof_image"
                                            placeholder="Enter Current Password">
                                        <span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="business_license_number" class="form-control"
                                            id="business_license_number" placeholder="Enter shop mobile number"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gst_number" class="form-control" id="gst_number"
                                            placeholder="Enter shop mobile number"
                                            value="{{ $vendorDetails->gst_number }}" required>
                                        <span class="text-danger">
                                            @error('gst_number')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pan_number" class="form-control" id="pan_number"
                                            placeholder="Enter shop mobile number"
                                            value="{{ $vendorDetails->pan_number }}" required>
                                        <span class="text-danger">
                                            @error('pan_number')
                                                {{ $message }}
                                            @enderror
                          ...
                          <form class="forms-sample" action="{{ url('admin/update-vendor-details/bank') }}"
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="bank_name" class="form-control" id="	bank_name"
                                      placeholder="Enter shop name" value="{{ $vendorDetails->bank_name }}"
                                      required>
                                  <span class="text-danger">
                                      @error('bank_name')
                                          {{ $message }}
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="account_number" class="form-control" id="account_number"
                                      placeholder="Enter shop address" value="{{ $vendorDetails->account_number }}" onkeypress="return (event.charCode > 47 && event.charCode <= 57 );"
                                      required>
                                  <span class="text-danger">
