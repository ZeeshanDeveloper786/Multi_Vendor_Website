            ...
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{url('admin/update-admin-details')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="admin_name" class="form-control" id="admin_name" placeholder="Enter New Password" value="{{Auth::guard('admin')->user()->name}}" required>
                    <span class="text-danger">@error('admin_name') {{$message}} @enderror</span>
                </div>
                <div class="form-group">
                    <label for="admin_mobile">Mobile</label>
                    <input type="text" name="admin_mobile" class="form-control" id="admin_mobile" placeholder="Enter Current Password" value="{{Auth::guard('admin')->user()->mobile}}" required>
                    <span class="text-danger">@error('admin_mobile') {{$message}} @enderror</span>
                </div>

                <div class="form-group">
                  <label for="admin_image">Admin image</label>
                  <input type="file" name="admin_image" class="form-control" id="admin_image" placeholder="Enter Current Password">
