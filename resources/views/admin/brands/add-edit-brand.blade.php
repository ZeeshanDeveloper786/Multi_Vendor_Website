        ...
        <div class="col-md-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" @if (empty($brandData->id))
                action="{{url('admin/admin/add-edit-brand')}}"
                @else
                action="{{url('admin/admin/add-edit-brand/'.$brandData->id)}}"
              @endif  
              method="POST" enctype="multipart/form-data">
                ...
                <a href="{{url('admin/brand')}}" class="btn btn-light">Cancel</button>
              </form>
            </div>
          </div>
        </div>
